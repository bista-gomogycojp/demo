...
class NewUser(AbstractBaseUser, PermissionsMixin):
    ...
    logo_box = models.TextField(verbose_name='ロゴボックス', null=True)
    dark = models.TextField(verbose_name='Dark', default=False)
    category = models.TextField(verbose_name='カテゴリー', null=True)
    category_item = models.TextField(verbose_name='カテゴリー項目', null=True)
    pagination = models.TextField(verbose_name='ページネーション', null=True)
