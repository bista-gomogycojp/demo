...
# Logo User
class logoSortSerializer(serializers.ModelSerializer):
    class Meta:
        model = NewUser
        fields = ('logo_box','user_name')

# Dark User

class DarkSerializer(serializers.ModelSerializer):
    class Meta:
        model = NewUser
        fields = ('dark','user_name')
...
class CategoryItemSerializer(serializers.ModelSerializer):
    class Meta:
        model = NewUser
        fields = ('category_item','user_name')

# Logo User
class PaginationSerializer(serializers.ModelSerializer):
    class Meta:
        model = NewUser
        fields = ('pagination','user_name')
